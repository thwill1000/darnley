...
"The Sealed Room Murder" is a murder mystery adventure game. The `mmbasic/` directory contains the active implementation written in MMBasic. The other directories (`psion3a/`, `tads3/`, `dbf-converter/`, `latest/`) contain historical implementations and resources.
...
**People data**: `id|space_separated_name_keywords`
