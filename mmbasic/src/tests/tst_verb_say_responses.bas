...
add_test("What do you think of Sarah Darnley?", "test_say_gvn_opinion_sarah")
add_test("What do you think of Millicent Darnley?", "test_say_gvn_opinion_millicent")
add_test("What do you think of Arthur Coniston?", "test_say_gvn_opinion_arthur")
add_test("What do you think of Sir Redvers Slingsby?", "test_say_gvn_opinion_redvers")
add_test("What do you think of Arnold Billingsgate?", "test_say_opinion_billingsgate")
add_test("What do you think of Mildred Goodbody?", "test_say_opinion_goodbody")
add_test("What do you think of Norah Bagsby?", "test_say_opinion_bagsby")
add_test("What do you think of Ronald Mellors?", "test_say_opinion_mellors")
...
Sub test_say_opinion_billingsgate()
